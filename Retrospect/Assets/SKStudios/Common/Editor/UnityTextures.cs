...
namespace SKStudios.Common.Editor {
    public class UnityTextures : EditorWindow {
        private readonly GUIContent _mBtnCntent = new GUIContent();


        private readonly int _mPathWidth = 350;
        private readonly int _mTextureHeight = 60;
        private readonly int _mTextureWidth = 60;
        ...
        {
            var window =
                (UnityTextures) GetWindow(typeof(UnityTextures), false, "UnityTextures");
            window.Show();
        }
        ...
        private void OnGUI()
        {
            ...
            EditorGUILayout.LabelField("path", GUILayout.Width(_mPathWidth));
            EditorGUILayout.LabelField("width", GUILayout.Width(_mTextureWidth));
            EditorGUILayout.LabelField("height", GUILayout.Width(_mTextureHeight));
            EditorGUILayout.EndHorizontal();


            if (_pathList == null || _pathList.Count == 0) {
                _pathList = new List<string>();
                _pathList = GetIconLists(_pathList);
            }
        ...
        private void GuiItem(string path)
        {
            ...
            _mBtnCntent.text = "";
            _mBtnCntent.tooltip = "";
            _mBtnCntent.image = tex;
            if (GUILayout.Button(_mBtnCntent, GUILayout.Width(50))) { }

            EditorGUILayout.TextField(path, GUILayout.Width(_mPathWidth));
            EditorGUILayout.LabelField(tex.width.ToString(), GUILayout.Width(_mTextureWidth));
            EditorGUILayout.LabelField(tex.height.ToString(), GUILayout.Width(_mTextureHeight));
        }

        private List<string> GetIconLists(List<string> pathList)
        {
            ...
            pathList.Add("icons/d_TreeEditor.OriginalMaterial On.png");
            pathList.Add("icons/d_TreeEditor.OriginalMaterial.png");
            ...
            pathList.Add("icons/TreeEditor.OriginalMaterial On.png");
            pathList.Add("icons/TreeEditor.OriginalMaterial.png");
